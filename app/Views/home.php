                ...
                <form action="<?= base_url(); ?>" method="post">
                                ...
                                <tr>
                                    ...
                                    for ($b; $b < $limit; $b++) : ?>
                                        <td><input id="cell-<?= $b; ?>" name="cell-<?= $b; ?>" type="text" pattern="\d*" maxlength="1" oninput="this.value=this.value.replace(/[^0-9]/g,'');" autocomplete="off" <?php if (isset($_POST["cell-$b"])) :
                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                    endif; ?> <?php if (isset($_SESSION["wrong"]) && in_array("$b", $_SESSION['wrong'])) : echo "style='background-color:yellow;'";
                                                                                                                                                                                                                                endif ?>></td>
                                    <?php endfor; ?>
                                </tr>
                            <?php endfor; ?>
                    ...
                    <div class="text-center mt-3">
                        ...
                        <a class="btn btn-success btn-lg <?php if (!$_SESSION['enable']) : echo 'disabled';
                                                            endif ?>" href="<?= base_url(); ?>/solve/<?php if (isset($_SESSION['sudoku'])) :
                                                                                                                echo implode("", $_SESSION['sudoku']);
                                                                                                            endif; ?>">Solve</a>
                    </div>
                </form>
            </div>
